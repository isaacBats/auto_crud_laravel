...
@section('styles')
	...
	<link href="{!! url('assets/css/fullcalendar-custom.css') !!}" rel="stylesheet">
		...
		<div class="col-md-3">
			...
			<div class="input-group demo-group">
				...
				<span class="input-group-btn">
					<button class="btn btn-primary btn-lg" id="create-event" type="button">Create!</button>
				</span>
			</div>
			...
			<div class="checkbox checkbox-success">
              	<input type='checkbox' name='drop-remove' id='drop-remove' class="styled"/>
...
@section('scripts')
	...
	<script src="{!! url('assets/js/full-calendar/moment.min.js') !!}"></script>
	<script src="{!! url('assets/js/full-calendar/fullcalendar.min.js') !!}"></script>
	<script src="{!! url('assets/js/full-calendar/fullcalendar-custom.min.js') !!}"></script>
