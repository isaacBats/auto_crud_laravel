...
<body>
    ...
    <div class="error-bg error-bg-two"></div>
    <!--errorbg-->
    <div class="error-block">
        <div class="error-head error-head-two">Ah! Something Went Wrong</div>
        <!--errorhead-->
        <div class="error-image">
            <img src="{!! url('assets/images/505error.png') !!}" alt="505">
        </div>
        <!--errorimage-->
        <a href="{!! url('home') !!}" class="error-link">Go Back To Home</a>
        <!--errorlink-->
    </div>
    <!--error-->
