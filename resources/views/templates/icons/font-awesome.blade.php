...
<div class="page_header">
	<div class="col-md-4">
		<div class="pull-left">
			<div class="main-text">Font Awesome Icons</div>
			<p class="block">
	...
	<div class="col-md-4">
		<div class="text-center">
			<i class="fa fa-flag page_header_icon"></i>
	...
	<div class="col-md-4">
		<div class="right pull-right">
			<ul class="right_bar">
				<li class="list-unstyled"><i class="ion ion-ios-checkmark-empty"></i> &nbsp;519+ Icons</li>
				<li class="list-unstyled"><i class="ion ion-ios-checkmark-empty"></i> &nbsp;Infinite Scalability</li>
				<li class="list-unstyled"><i class="ion ion-ios-checkmark-empty"></i> &nbsp;CSS Control</li>
				<li class="list-unstyled"><i class="ion ion-ios-checkmark-empty"></i> &nbsp;No JavaScript Required</li>
		...
		<div class="panel knot-panel panel-primary">
			...
			<div class="panel-body">
				<div class="row fontawesome-icon-list">
					...
					<div class="fa-hover col-md-3 col-sm-4">
						<i class="icon ti-close"></i> fa-times
					</div>
					...
					<div class="fa-hover col-md-3 col-sm-4">
						<i class="icon ti-reload"></i> fa-refresh
					</div>
					...
					<div class="fa-hover col-md-3 col-sm-4">
						<i class="icon ti-angle-up"></i> fa-chevron-up
					</div>
